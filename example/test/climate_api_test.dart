...
void main() {
  group('Climate Api Tests', () {
    ...
    test(
      ...
      () async {
        await averageRainfallForGreatBritainFrom1985To1995DoesNotExist(climateApi);
      },
    );
    ...
    test(
      ...
      () async {
        await averageRainfallForMiddleEarthFrom1980To1999DoesNotExist(climateApi);
      },
    );
    ...
    test(
      ...
      () async {
        await averageRainfallForGreatBritainAndFranceFrom1980T01999CanBeCalculatedFromTwoRequests(climateApi);
      },
    );
  });
}
...
Future averageRainfallForFranceFrom1980To1999Exists(ClimateApi climateApi) async {
  expect(
    await climateApi.getAverageAnnualRainfall(
      fromYear: 1980,
      toYear: 1999,
...
Future averageRainfallForEgyptFrom1980To1999Exists(ClimateApi climateApi) async {
  expect(
    await climateApi.getAverageAnnualRainfall(
      fromYear: 1980,
      toYear: 1999,
...
Future averageRainfallForGreatBritainFrom1985To1995DoesNotExist(ClimateApi climateApi) async {
  try {
    await climateApi.getAverageAnnualRainfall(
      fromYear: 1985,
      toYear: 1995,
...
Future averageRainfallForMiddleEarthFrom1980To1999DoesNotExist(ClimateApi climateApi) async {
  try {
    await climateApi.getAverageAnnualRainfall(
      fromYear: 1980,
      toYear: 1999,
...
Future averageRainfallForGreatBritainAndFranceFrom1980T01999CanBeCalculatedFromTwoRequests(ClimateApi climateApi) async {
  expect(
    await climateApi.getAverageAnnualRainfall(
      fromYear: 1980,
      toYear: 1999,
